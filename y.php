<?php
ob_start();
$token = "6077491662:AAHwkVGr_uCRV1Rz3zxI4Z5rR45_H6gdfLs"; 
...
$item = json_decode(file_get_contents("https://lmasat.tk/API/api_c/bhth.php?search=".urlencode($text)))->results;      	
...
$YutDl= json_decode(file_get_contents("https://lmasat.tk/API/api_c/index.php?url=https://youtu.be/".$IdVideo2),true);
	$YutDl2 = $YutDl["url"][0]["url"];
	$metitle = $YutDl["meta"]["title"];
$mda = $YutDl["meta"]["duration"];
$Phho = "sendphoto";
